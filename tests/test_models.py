...
class TestOptionContract:
    ...
    def test_is_call_property(self):
        ...
        call = OptionContract(
            symbol="F", strike=10.0, expiration_date="2026-01-16", option_type="Call"
        )
        put = OptionContract(
            symbol="F", strike=10.0, expiration_date="2026-01-16", option_type="Put"
        )
    ...
    def test_bid_ask_spread_missing_bid(self):
        ...
        contract = OptionContract(
            symbol="F", strike=10.0, expiration_date="2026-01-16", option_type="Call", ask=1.30
        )
    ...
    def test_bid_ask_spread_missing_ask(self):
        ...
        contract = OptionContract(
            symbol="F", strike=10.0, expiration_date="2026-01-16", option_type="Call", bid=1.25
        )
    ...
    def test_mid_price_missing_values(self):
        ...
        contract_no_ask = OptionContract(
            symbol="F", strike=10.0, expiration_date="2026-01-16", option_type="Call", bid=1.20
        )
...
class TestOptionsChain:
    ...
    def test_options_chain_initialization(self, sample_contracts):
        ...
        chain = OptionsChain(
            symbol="F", contracts=sample_contracts, retrieved_at="2026-01-13T12:00:00Z"
        )
    ...
    def test_empty_chain(self):
        ...
        chain = OptionsChain(symbol="F", contracts=[], retrieved_at="2026-01-13T12:00:00Z")
